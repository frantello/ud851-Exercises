...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RAW_JSON = "searchRawJson";
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String searchRawJson = mSearchResultsTextView.getText().toString();
        // COMPLETED (8) Using the key for the raw JSON search results, put the search results into the outState Bundle
        outState.putString(SEARCH_RAW_JSON, searchRawJson);
    }
}